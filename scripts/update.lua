...
function main()
    ...
    os.cd(name)
    os.exec("git push git@gitlab.com:%s.git dev", name == "xmake-repo" and (repo:gsub("xmake%-io/", "tboox/")) or repo)
    ...
    os.exec("git push git@gitlab.com:%s.git master", name == "xmake-repo" and (repo:gsub("xmake%-io/", "tboox/")) or repo)
